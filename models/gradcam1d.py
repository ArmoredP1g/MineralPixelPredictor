# pasted from
# https://github.com/haofanwang/Grad-CAM-pytorch/blob/master/gradcam.py
import torch
...
class BaseCAM:
    ...
    def __call__(self, input_tensor, target_category=None):
        ...
        if len(input_tensor.shape) == 2:
            ...
            # 3维输入 [batch, channels, length]
            target_length = input_tensor.shape[2]
        cam = resize_1d(cam, target_length)
