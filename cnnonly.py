...
import torch
from trainer import train_predictor
from configs.training_cfg import device, learning_rate, lr_decay, lr_lower_bound, session_tag
from deep_learning_experiment import build_deep_learning_folds, build_test_data, build_train_loaders, write_training_manifest, split_fold_lists
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        _, trainloader_predictor = build_train_loaders(training_list)
