...
if __name__ == "__main__":
    train_list = ['10_A', '10_B', '10_C', '11_A', '11_B', '11_C', '12_A', 
    ...
    '26_B', '26_C', '9_A', '9_B', '9_C']
    train_set = dataset_iron("notbooks/spectral_data_winsize10.csv", "notbooks/spectral_data_winsize10.hdf5", train_list, 500)
    ...
    train_regression(train_loader, model, 1000000, lr=0.0005, tag="500采样 autocast worker", vis=model.visualization)
